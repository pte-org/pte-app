...
import '../../dev/writing_task_fixtures.dart';
import '../../domain/task_view.dart';
import '../widgets/passage_panel.dart';
import '../widgets/text_editor_toolbar.dart';
import '../widgets/writing_task_header.dart';
...
/// `ExamScaffold`; the chrome dev preview ([WritingPreviewWeb]) mounts
/// this directly.
...
class _WordCountFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      '$count${AppStrings.wordCountSuffix}'
