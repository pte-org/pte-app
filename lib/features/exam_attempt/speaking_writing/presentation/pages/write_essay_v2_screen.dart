...
/// Production wrapper for Write Essay. It owns persistence dependencies while
/// [WriteEssayV2Body] stays reusable by the Chrome-only development preview.
class WriteEssayV2Screen extends StatelessWidget {
  const WriteEssayV2Screen({
    super.key,
    required this.task,
