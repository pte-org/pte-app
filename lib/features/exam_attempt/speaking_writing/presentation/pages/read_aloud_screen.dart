...
class _RecordingBody extends StatelessWidget {
            ...
            children: [
              Text(
                switch (state.recordingPhase) {
                  ...
                  RecordingPhase.idle => SpeakingWritingStrings.readAloudNotRecordedYetLabel,
                },
              ),
              const SizedBox(height: AppDimensions.spacingMedium),
              PrimaryButton(
                label: state.recordingPhase == RecordingPhase.recording
                    ? SpeakingWritingStrings.readAloudStopRecordingLabel
  ...
  String _uploadStatusLabel(ReadAloudState state) {
    ...
    if (status == null) return SpeakingWritingStrings.readAloudNotRecordedYetLabel;
    return status == PendingMediaUploadStatus.ready
        ? SpeakingWritingStrings.readAloudUploadReadyLabel
        : SpeakingWritingStrings.readAloudStillUploadingLabel;
  }
}
